...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Envie sua logo atual, receba um diagnóstico de design e 4 propostas de redesign geradas por IA, com refinamento por conversa e download em alta resolução.",
      },
      ...
      { name: "twitter:description", content: "Envie sua logo atual, receba um diagnóstico de design e 4 propostas de redesign geradas por IA, com refinamento por conversa e download em alta resolução." },
